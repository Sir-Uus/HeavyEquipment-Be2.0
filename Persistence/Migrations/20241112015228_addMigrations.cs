        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServicedPerformed = table.Column<string>(type: "text", nullable: true),
                    ServicedProvider = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaintenancedRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MaintenancedRecords_Equipments_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "Equipments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PerformanceFeedbacks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PerformanceFeedbacks_Equipments_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "Equipments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RentalHistories_AspNetUsers_RenterId",
                        column: x => x.RenterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RentalHistories_Equipments_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "Equipments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RentalRequests_Equipments_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "Equipments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    RentalRequestId = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SparePartFeedbacks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SparePartFeedbacks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SparePartFeedbacks_SpareParts_SparePartId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SparePartId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransactionDetails_SpareParts_SparePartId",
                        column: x => x.SparePartId,
                        principalTable: "SpareParts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenancedRecords_EquipmentId",
                table: "MaintenancedRecords",
                column: "EquipmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PerformanceFeedbacks_EquipmentId",
                table: "PerformanceFeedbacks",
                column: "EquipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_PerformanceFeedbacks_UserId",
                table: "PerformanceFeedbacks",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_RentalHistories_EquipmentId",
                table: "RentalHistories",
                column: "EquipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_RentalHistories_RenterId",
                table: "RentalHistories",
                column: "RenterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SparePartFeedbacks_SparePartId",
                table: "SparePartFeedbacks",
                column: "SparePartId");

            migrationBuilder.CreateIndex(
                name: "IX_SparePartFeedbacks_UserId",
                table: "SparePartFeedbacks",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionDetails_SparePartId",
                table: "TransactionDetails",
                column: "SparePartId");
